                                ...
                                @foreach ($blockedMods as $blockedMod)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <a href="{{ route('manage-users.show', $blockedMod->slug) }}" class="btn btn-success btn-sm" title="@lang('admin.view_user_info')"><i class="fa fa-eye"></i> @lang('admin.view_user_info')</a>
                                                </div>
                                                <div class="col-md-3">
