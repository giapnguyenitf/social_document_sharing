        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <h3 class="box-title">@lang('admin.list_report_document')</h3>
                    </div>
                    <div class="box-body">
                                ...
                                @foreach ($documents as $document)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <a href="{{ route('manage-document.detail-report', $document->slug) }}" class="btn btn-primary btn-sm" title="@lang('admin.view_document')"><i class="fa fa-eye"></i></a>
                                                </div>
                                                <div class="col-md-3">
